...
<body>
    <?php include "nav.php";
    include ('connect.php');
    $result_category = mysqli_query($mysqli, "SELECT * FROM kategori_mobil") or die(mysqli_error($mysqli));
    ...
    <div class="card-container">
        ...
        while ($data = mysqli_fetch_array($result_category)) {
            ?>
            <div class="card">
                <a href="kategori.php?id=<?php echo $data["id_kategori"];?>">
                    <center>
                        <strong>
    ...
    <body>
        <section class="catalog">
            <div class="card-container">
                ...
                $result = mysqli_query($mysqli, "SELECT * FROM mobil") or die(mysqli_error($mysqli));
