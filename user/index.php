...
<head>
    ...
    <link rel="stylesheet" href="hitam.css">
...
<body>
    ...
    <nav>
        <div class="navbar">
        <div class="logo">Kai Cars</div>
            <ul>
                <li><a href="beranda.php">Beranda</a></li>
                <li><a href="katalog.php">Katalog</a></li>
                <li><a href="history.php">Transaksi</a></li>
                <li>
                <li style="margin-right:12px; "><button class="btn" onclick="window.location='login.php'">Login</button>
            </li>
            <li style=><button class="btn" onclick="window.location='register.php'">Register</button></li>
                </li>
            </ul>
        </div>
    </nav>
        <!-- <a href="#" class="logo">Kai Cars</a>
        <div class="bx bx-menu" id="menu-icon"></div>

        <ul class="navbar">
            <li><a href="#">Beranda</a></li>
            <li><a href="#">Katalog</a></li>
            <li style="margin-right:50px"><a href="#">Transaksi</a></li>
    ...
    <section class="home" id="home">
        <div class="home-text">
            ...
            <a href="regist" class="btn">Register</a>
        </div>
